...
public class EventDao {
	...
	public int insertEvent(Event e) {
		String query = "insert into event values(event_file_seq.nextval,?,?,to_char(sysdate,'yyyy-mm-dd'),0,?,?)";
		Object[]params = {e.getEventTitle(),e.getEventContent(),e.getMemberNo(),e.getFilepath()};
